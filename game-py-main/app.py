...
IMAGEM_BACKGROUND = pygame.transform.scale2x(
    pygame.image.load(os.path.join('imgs', 'floresta.jpg'))
)

IMAGENS_PASSARO = [
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'arara1.png'))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'arara2.png'))
    ),
    pygame.transform.scale2x(
        pygame.image.load(os.path.join('imgs', 'arara3.png'))
    )
]
